  ...
  return (
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-[32px] overflow-hidden bg-brand-heading p-8 md:p-16 text-center border-t-4 border-brand-blue/20 shadow-2xl shadow-brand-blue/10">
